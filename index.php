							...
							<div id="testimonials-section" class="text-center">
								<div class="container">
									<div class="section-title wow fadeInDown">
										<h2 class="block-title title-light text-center animated infinite pulse"><font color="#DCDCDC"><i class="fa fa-bullhorn fa-2x"></i><br><br><strong>NOVIDADES</font></strong></h2>
									</div>
									<div class="row">
